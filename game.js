...
function updatePhysics() {
    ...
    for (let step = 0; step < SUB_STEPS; step++) {
            ...
            if (cap.x > goalLeft && cap.x < goalRight) {
                ...
                if (gameMode === 'online') {
                    ...
                    if (myTeamNumber === 1) {
                        ...
                        // Ben Takım 2 isem rakip skoru artar
                        score.p2++;
        ...
        // === ALT KALE (Takım 1'in kalesi - Oyuncu 1 gol atar) ===
